        ...
        <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            <div className="relative">
              ...
              <img
                src="https://images.unsplash.com/photo-1577896851231-70ef18881754?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
      ...
      <section className="section-container">
        <div className="bg-white rounded-2xl overflow-hidden shadow-lg card-shadow flex flex-col md:flex-row">
          <div className="md:w-1/2">
            <img 
              src="https://images.unsplash.com/photo-1536337005238-94b997371b40?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
              alt="Child in a wheelchair smiling"
          ...
          <div className="md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Meet Samantha</h2>
            <p className="text-gray-600 mb-6">
              Samantha was born with cerebral palsy and faced challenges accessing quality education. Through our support program, she received a specialized wheelchair and assistive learning technology. Today, she's thriving in school and pursuing her passion for art.
            </p>
