  ...
  return (
    <>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">123 Empowerment Street</p>
                    <p className="text-white/80">Caring City, CC 10001</p>
                  </div>
                </div>
      ...
      <section className="relative h-96 bg-gray-200">
        <div className="absolute inset-0 bg-empowerkind-darkPurple/20 flex items-center justify-center z-10">
          <div className="bg-white p-6 rounded-xl shadow-xl max-w-md w-full text-center">
            <h3 className="text-xl font-bold text-empowerkind-darkPurple mb-3">Visit Our Center</h3>
            <p className="text-gray-600 mb-4">
              123 Empowerment Street<br />
              Caring City, CC 10001
            </p>
            <a 
              href="https://maps.google.com" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-block bg-empowerkind-purple text-white px-4 py-2 rounded-lg hover:bg-empowerkind-darkPurple transition-colors"
            >
              Get Directions
            </a>
          </div>
        ...
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3306.0834771798513!2d-118.34638192422577!3d34.08401917313042!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2b8d3b1e0287d%3A0x9cc32be17df028b8!2sCedar%20Sinai%20Medical%20Center!5e0!3m2!1sen!2sus!4v1681522653095!5m2!1sen!2sus" 
          width="100%" 
          height="100%" 
          style={{ border: 0 }} 
          allowFullScreen 
