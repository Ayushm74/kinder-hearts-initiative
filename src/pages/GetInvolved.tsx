...
const GetInvolved = () => {
  ...
  return (
    <>
      ...
      {/* Volunteer Spotlight */}
      <section className="bg-empowerkind-lightPurple py-16 md:py-24 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="section-title">Volunteer Spotlight</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Meet the amazing people who are making a difference in the lives of our children.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-empowerkind-coral mb-4">Art Therapy Volunteer</p>
                <p className="text-gray-600">
                  "Volunteering with EmpowerKind has been one of the most rewarding experiences of my life. Seeing the children express themselves through art and witnessing their progress is incredible."
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md">
              <div className="h-64 overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1556157382-97eda2f9e946?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                  alt="Volunteer David"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-2">David Rodriguez</h3>
                <p className="text-empowerkind-coral mb-4">Sports Coach</p>
                <p className="text-gray-600">
                  "I've been coaching adaptive sports for three years now. The resilience and determination these children show is truly inspiring. They teach me something new every day."
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md">
              <div className="h-64 overflow-hidden">
                <img
                  ...
                  alt="Volunteer Michelle"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Michelle Chen</h3>
                <p className="text-empowerkind-coral mb-4">Reading Buddy</p>
                <p className="text-gray-600">
                  "Spending time reading with the children is the highlight of my week. Watching their faces light up when they understand a story is pure joy."
                </p>
              </div>
            </div>
          </div>
